...
CREATE TABLE "project" ("id" INTEGER NOT NULL, "type" VARCHAR(50) NOT NULL, "name" VARCHAR(50) NOT NULL, "company" VARCHAR(30), "created_at" TIMESTAMPTZ NOT NULL DEFAULT NOW());
